...
export async function runFullGovernAPIScanner(scanId: string, target: string, scanType: string) {
  ...
  return new Promise((resolve, reject) => {
    ...
    child.stderr.on('data', (data) => console.error('Scanner:', data.toString()));
