...
export type Permission = 'read' | 'write' | 'delete' | 'manage_users' | 'configure_policies' | 'manage_scans' | 'view_reports' | 'create_reports'
...
export function requirePermission(permission: Permission) {
  return function(req: AuthenticatedRequest, res: ApiResponse, next: () => void) {
